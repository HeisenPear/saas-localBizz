/**
 * Next.js Middleware for LocalBiz Engine
 *
 * This middleware runs on every request and handles:
 * 1. Authentication state management with Supabase
...
export const config = {
  matcher: [
     ...
     * - public folder files
     * - api/webhooks (webhooks don't need auth middleware)
     */
